...
if (PART == "all") translate([180, 225, 0]) knmnt_l_bar1();
if (PART == "knmnt_l_bar1") knmnt_l_bar1();
if (PART == "all") translate([225, 225, 0]) knmnt_l_bar2();
if (PART == "knmnt_l_bar2") knmnt_l_bar2();
if (PART == "all") translate([0, 270, 0]) knmnt_r_bar1();
if (PART == "knmnt_r_bar1") knmnt_r_bar1();
if (PART == "all") translate([45, 270, 0]) knmnt_r_bar2();
if (PART == "knmnt_r_bar2") knmnt_r_bar2();
if (PART == "all") translate([90, 270, 0]) rail_l();
if (PART == "rail_l") rail_l();
if (PART == "all") translate([135, 270, 0]) rail_r();
if (PART == "rail_r") rail_r();
if (PART == "all") translate([180, 270, 0]) rollhorn_l();
if (PART == "rollhorn_l") rollhorn_l();
if (PART == "all") translate([225, 270, 0]) rollhorn_r();
if (PART == "rollhorn_r") rollhorn_r();
if (PART == "all") translate([0, 315, 0]) rollhornp_l();
if (PART == "rollhornp_l") rollhornp_l();
if (PART == "all") translate([45, 315, 0]) rollhornp_r();
if (PART == "rollhornp_r") rollhornp_r();
if (PART == "all") translate([90, 315, 0]) rollmnt_l_bar1();
if (PART == "rollmnt_l_bar1") rollmnt_l_bar1();
if (PART == "all") translate([135, 315, 0]) rollmnt_l_bar2();
if (PART == "rollmnt_l_bar2") rollmnt_l_bar2();
if (PART == "all") translate([180, 315, 0]) rollmnt_r_bar1();
if (PART == "rollmnt_r_bar1") rollmnt_r_bar1();
if (PART == "all") translate([225, 315, 0]) rollmnt_r_bar2();
if (PART == "rollmnt_r_bar2") rollmnt_r_bar2();
if (PART == "all") translate([0, 360, 0]) shdrive_l();
if (PART == "shdrive_l") shdrive_l();
if (PART == "all") translate([45, 360, 0]) shdrive_r();
if (PART == "shdrive_r") shdrive_r();
if (PART == "all") translate([90, 360, 0]) shell_back();
if (PART == "shell_back") shell_back();
if (PART == "all") translate([135, 360, 0]) shell_front();
if (PART == "shell_front") shell_front();
if (PART == "all") translate([180, 360, 0]) shell_top();
if (PART == "shell_top") shell_top();
if (PART == "all") translate([225, 360, 0]) shindrive_l();
if (PART == "shindrive_l") shindrive_l();
if (PART == "all") translate([0, 405, 0]) shindrive_r();
if (PART == "shindrive_r") shindrive_r();
if (PART == "all") translate([45, 405, 0]) shinweb_l();
if (PART == "shinweb_l") shinweb_l();
if (PART == "all") translate([90, 405, 0]) shinweb_r();
if (PART == "shinweb_r") shinweb_r();
if (PART == "all") translate([135, 405, 0]) shmnt_l_bar1();
if (PART == "shmnt_l_bar1") shmnt_l_bar1();
if (PART == "all") translate([180, 405, 0]) shmnt_l_bar2();
if (PART == "shmnt_l_bar2") shmnt_l_bar2();
if (PART == "all") translate([225, 405, 0]) shmnt_r_bar1();
if (PART == "shmnt_r_bar1") shmnt_r_bar1();
if (PART == "all") translate([0, 450, 0]) shmnt_r_bar2();
if (PART == "shmnt_r_bar2") shmnt_r_bar2();
if (PART == "all") translate([45, 450, 0]) shrollmnt_l_bar1();
if (PART == "shrollmnt_l_bar1") shrollmnt_l_bar1();
if (PART == "all") translate([90, 450, 0]) shrollmnt_l_bar2();
if (PART == "shrollmnt_l_bar2") shrollmnt_l_bar2();
if (PART == "all") translate([135, 450, 0]) shrollmnt_r_bar1();
if (PART == "shrollmnt_r_bar1") shrollmnt_r_bar1();
if (PART == "all") translate([180, 450, 0]) shrollmnt_r_bar2();
if (PART == "shrollmnt_r_bar2") shrollmnt_r_bar2();
if (PART == "all") translate([225, 450, 0]) sole_l();
if (PART == "sole_l") sole_l();
if (PART == "all") translate([0, 495, 0]) sole_r();
if (PART == "sole_r") sole_r();
if (PART == "all") translate([45, 495, 0]) spinearm();
if (PART == "spinearm") spinearm();
if (PART == "all") translate([90, 495, 0]) spinedrive();
if (PART == "spinedrive") spinedrive();
if (PART == "all") translate([135, 495, 0]) spinedrop();
if (PART == "spinedrop") spinedrop();
if (PART == "all") translate([180, 495, 0]) spinemnt_bar1();
if (PART == "spinemnt_bar1") spinemnt_bar1();
if (PART == "all") translate([225, 495, 0]) spinemnt_bar2();
if (PART == "spinemnt_bar2") spinemnt_bar2();
if (PART == "all") translate([0, 540, 0]) thighdrive_l();
if (PART == "thighdrive_l") thighdrive_l();
if (PART == "all") translate([45, 540, 0]) thighdrive_r();
if (PART == "thighdrive_r") thighdrive_r();
if (PART == "all") translate([90, 540, 0]) thighweb_l();
if (PART == "thighweb_l") thighweb_l();
if (PART == "all") translate([135, 540, 0]) thighweb_r();
if (PART == "thighweb_r") thighweb_r();
if (PART == "all") translate([180, 540, 0]) yawplate_l();
if (PART == "yawplate_l") yawplate_l();
if (PART == "all") translate([225, 540, 0]) yawplate_r();
